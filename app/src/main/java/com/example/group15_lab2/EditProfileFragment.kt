...
class EditProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if(savedInstanceState==null) {
            rotation = arguments?.getFloat("group15.lab1.AVATAR_ROTATION") ?: 0F
            showImage(arguments?.getByteArray("group15.lab1.AVATAR"), rotation)
            user_fullname_edit.setText(arguments?.getString("group15.lab1.FULL_NAME"))
            user_nickname_edit.setText(arguments?.getString("group15.lab1.NICKNAME"))
            user_email_edit.setText(arguments?.getString("group15.lab1.EMAIL"))
            user_location_edit.setText(arguments?.getString("group15.lab1.LOCATION"))
            user_address_edit.setText(arguments?.getString("group15.lab1.ADDRESS"))
            user_telephone_edit.setText(arguments?.getString("group15.lab1.TELEPHONE"))
        } else{
